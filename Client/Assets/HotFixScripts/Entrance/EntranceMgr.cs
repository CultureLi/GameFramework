...
namespace Entrance
{
    internal partial class EntranceMgr
    {
        ...
        public IEnumerator LoadLocalFile(string relativePath, Action<DownloadHandler> completedCb)
        {
            ...
            return LoadFile(rootPaths, relativePath, completedCb);
        }

        public IEnumerator LoadFile(string[] rootPaths, string relativePath, Action<DownloadHandler> completedCb)
        {
        ...
        public void ReloadCatalog()
        {
            ...
            var path = PathDefine.persistentCatalogPath;
            if (!File.Exists(path))
            {
                path = PathDefine.originCatalogPath;
            }
