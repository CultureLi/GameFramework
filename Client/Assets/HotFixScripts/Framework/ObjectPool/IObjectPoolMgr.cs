...
namespace Framework
{
    ...
    public interface IObjectPoolMgr
    {
        ...
        IObjectPool<T> CreateSingleSpawnObjectPool<T>(string name, float autoReleaseInterval, int capacity, float expireTime) where T : ObjectBase;
        ...
        IObjectPool<T> CreateMultiSpawnObjectPool<T>(string name, float autoReleaseInterval, int capacity, float expireTime) where T : ObjectBase;
