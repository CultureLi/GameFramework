...
namespace Framework
{
    ...
    public interface IUIManager
    {
        ...
        /// 打开界面更新事件。
        /// </summary>
        event EventHandler<OpenUIFormUpdate> OpenUIFormUpdate;

        /// <summary>
        /// 打开界面时加载依赖资源事件。
        /// </summary>
        event EventHandler<OpenUIFormDependencyAsset> OpenUIFormDependencyAsset;

        /// <summary>
        /// 关闭界面完成事件。
        /// </summary>
        event EventHandler<CloseUIFormComplete> CloseUIFormComplete;
