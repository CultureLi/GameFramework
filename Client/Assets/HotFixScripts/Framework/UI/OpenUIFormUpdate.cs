namespace Framework
{
    ...
    /// 打开界面更新事件。
    /// </summary>
    public sealed class OpenUIFormUpdate : EventBase
    {
        /// <summary>
        /// 初始化打开界面更新事件的新实例。
        /// </summary>
        public OpenUIFormUpdate()
        {
            SerialId = 0;
        ...
        public static OpenUIFormUpdate Create(int serialId, string uiFormAssetName, string uiGroupName, bool pauseCoveredUIForm, float progress, object userData)
        {
            OpenUIFormUpdate openUIFormUpdateEventArgs = ReferencePool.Acquire<OpenUIFormUpdate>();
