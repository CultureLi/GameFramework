...
namespace Framework
{
    ...
    /// 关闭界面完成事件。
    /// </summary>
    public sealed class CloseUIFormComplete : EventBase
    {
        /// <summary>
        /// 初始化关闭界面完成事件的新实例。
        /// </summary>
        public CloseUIFormComplete()
        {
            SerialId = 0;
        ...
        public static CloseUIFormComplete Create(int serialId, string uiFormAssetName, IUIGroup uiGroup, object userData)
        {
            CloseUIFormComplete closeUIFormCompleteEventArgs = ReferencePool.Acquire<CloseUIFormComplete>();
