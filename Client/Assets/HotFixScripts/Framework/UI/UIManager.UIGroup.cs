    ...
    internal sealed partial class UIManager : IFramework, IUIManager
    {
        ...
        private sealed partial class UIGroup : IUIGroup
        {
            ...
            public void RemoveUIForm(IUIForm uiForm)
            {
                ...
                if (uiFormInfo == null)
                {
                    throw new Exception($"Can not find UI form info for serial id '{uiForm.SerialId}', UI form asset name is '{uiForm.UIFormAssetName}'.");
                }
                ...
                {
                    throw new Exception($"UI group '{m_Name}' not exists specified UI form '[{uiForm.SerialId}]{uiForm.UIFormAssetName}'.");
                }
