...
namespace cfg
{
    public partial class TbItemSummaryCfg : TableBase
    {
        ...
        private System.Collections.Generic.Dictionary<int, ItemSummaryCfg> _dataMap;
        ...
        private readonly System.Collections.Generic.List<ItemSummaryCfg> _dataList;
        ...
        {
            _dataMap = new System.Collections.Generic.Dictionary<int, ItemSummaryCfg>();
        ...
        public void LoadAll(System.Action<int,ItemSummaryCfg> onLoad = null)
        {
        ...
        public ItemSummaryCfg Get(int key)
        {
            ...
            v = global::cfg.ItemSummaryCfg.DeserializeItemSummaryCfg(buf);;
            _dataMap[key] = v;
            return v;
        }
