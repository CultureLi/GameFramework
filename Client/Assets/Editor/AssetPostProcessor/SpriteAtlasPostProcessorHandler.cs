...
{
    internal class SpriteAtlasPostprocessorHandler : IAssetPostprocessorHandler
    {
        ...
        public void OnPostprocessAllAssets(CustomAssetPostProcessor.AssetTypePostData data)
        {
            ...
            HandleSpriteAtlasSetting(data.importedAssets);
            RefreshSpriteMapper(data);
        }

        void HandleSpriteAtlasSetting(List<string> importedAssets)
        {
